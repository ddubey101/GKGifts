      ...
      <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === "ios" ? "padding" : "height"}>
        <ScrollView contentContainerStyle={{ padding: spacing.lg, paddingBottom: 180, gap: spacing.lg }} keyboardShouldPersistTaps="handled">
          <View style={s.card}>
            ...
            {!showAddForm ? (
              <Pressable testID="add-address-btn" onPress={() => setShowAddForm(true)} style={s.addBtn}><Ionicons name="add" size={16} color={colors.brandPrimary} /><Text style={{ color: colors.brandPrimary, marginLeft: 6 }}>Add address</Text></Pressable>
            ) : (
